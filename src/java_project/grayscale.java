...
public class grayscale extends javax.swing.JFrame {
    ...
    public grayscale(image im) {
        initComponents();
        this.im = im;
        this.jLabel1.setIcon(new ImageIcon(im.Resize(jLabel1.getWidth(), jLabel1.getHeight())));
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new grayscale(im).setVisible(true);
            }
        });
    }

    public void gray(image im){
        this.jLabel1.setIcon(new ImageIcon(im.Resize(jLabel1.getWidth(), jLabel1.getHeight())));
    }
